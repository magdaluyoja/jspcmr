...
!function (a, b) {
  ...
  var c = [],
    ...
    return this.length;
  }, n.fn.andSelf = n.fn.addBack, "function" == "function" && __webpack_require__(0) && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = (function () {
    return n;
...
function _ajaxLink(ajax) {
	...
	if (ajax === true) {
		jQuery("a").bind("click", function (e) {
			if (!jQuery(this).hasClass('external') && jQuery(this).attr('href') != '#' && jQuery(this).attr('href') != 'javascript:;' && jQuery(this).attr('href') != 'javascript:void(0);' && jQuery(this).attr('href') != 'javascript:void(0)') {
				e.preventDefault();
...
function _slimScroll() {
	...
	jQuery('.slimscroll').each(function () {
		...
		jQuery(this).slimScroll((_jQuery$slimScroll = {
		...
		}, _defineProperty(_jQuery$slimScroll, 'railVisible', jQuery(this).attr("data-railVisible") != "false" ? true : false), _defineProperty(_jQuery$slimScroll, 'color', jQuery(this).attr("data-color") || '#333'), _defineProperty(_jQuery$slimScroll, 'wrapperClass', jQuery(this).attr("data-wrapper-class") || 'slimScrollDiv'), _defineProperty(_jQuery$slimScroll, 'railColor', jQuery(this).attr("data-railColor") || '#eaeaea'), _defineProperty(_jQuery$slimScroll, 'height', height), _jQuery$slimScroll));
		...
		loadScript(plugin_path + 'spectrum/spectrum.min.js', function () {
			...
			if (jQuery().spectrum) {
				...
				_container_4.each(function () {
					...
					var _t = jQuery(this),
					    _preferredFormat = _t.attr('data-format') || "hex",
					    // hex, hex3, hsl, rgb, name
					...
					_t.spectrum((_t$spectrum = {
						...
						color: _color
					}, _defineProperty(_t$spectrum, 'showInput', true), _defineProperty(_t$spectrum, 'showPalette', true), _defineProperty(_t$spectrum, 'preferredFormat', _preferredFormat), _defineProperty(_t$spectrum, 'showAlpha', _preferredFormat == "rgb" ? true : false), _defineProperty(_t$spectrum, 'palette', _palette), _t$spectrum));
				});
			}
		});
	}
...
(function (b, f, i) {
	function l() {
		...
		var a = b(this),
		    d;a.is(":password") || (a.data("password") ? (d = a.next().show().focus(), b("label[for=" + a.attr("id") + "]").attr("for", d.attr("id")), a.remove()) : a.realVal() == a.attr("placeholder") && (a.val(""), a.removeClass("placeholder")));
	}function k() {
		var a = b(this),
		    d,
		    c;placeholder = a.attr("placeholder");b.trim(a.val()).length > 0 || (a.is(":password") ? (c = a.attr("id") + "-clone", d = b("<input/>").attr(b.extend(m(this), { type: "text", value: placeholder, "data-password": 1, id: c })).addClass("placeholder"), a.before(d).hide(), b("label[for=" + a.attr("id") + "]").attr("for", c)) : (a.val(placeholder), a.addClass("placeholder")));
	}var g = "placeholder" in f.createElement("input"),
	    h = "placeholder" in f.createElement("textarea"),
	    c = ":input[placeholder]";b.placeholder = { input: g, textarea: h };!i && g && h ? b.fn.placeholder = function () {} : (!i && g && !h && (c = "textarea[placeholder]"), b.fn.realVal = b.fn.val, b.fn.val = function () {
		var a = b(this),
		    d;if (arguments.length > 0) return a.realVal.apply(this, arguments);d = a.realVal();a = a.attr("placeholder");return d == a ? "" : d;
	}, b.fn.placeholder = function () {
		this.filter(c).each(k);return this;
	}, b(function (a) {
		var b = a(f);b.on("submit", "form", l);b.on("focus", c, j);b.on("blur", c, k);a(c).placeholder();
	}));
...
(function (e) {
	e.fn.extend({ slimScroll: function slimScroll(g) {
			var a = e.extend({ width: "auto", height: "250px", size: "7px", color: "#000", position: "right", distance: "1px", start: "top", opacity: .4, alwaysVisible: !1, disableFadeOut: !1, railVisible: !1, railColor: "#333", railOpacity: .2, railDraggable: !0, railClass: "slimScrollRail", barClass: "slimScrollBar", wrapperClass: "slimScrollDiv", allowPageScroll: !1, wheelStep: 20, touchScrollStep: 200, borderRadius: "7px", railBorderRadius: "7px" }, g);this.each(function () {
				function u(d) {
					if (r) {
						d = d || window.event;var c = 0;d.wheelDelta && (c = -d.wheelDelta / 120);d.detail && (c = d.detail / 3);e(d.target || d.srcTarget || d.srcElement).closest("." + a.wrapperClass).is(b.parent()) && m(c, !0);d.preventDefault && !k && d.preventDefault();k || (d.returnValue = !1);
					}
				}function m(d, e, g) {
					k = !1;var f = d,
					    h = b.outerHeight() - c.outerHeight();e && (f = parseInt(c.css("top")) + d * parseInt(a.wheelStep) / 100 * c.outerHeight(), f = Math.min(Math.max(f, 0), h), f = 0 < d ? Math.ceil(f) : Math.floor(f), c.css({ top: f + "px" }));l = parseInt(c.css("top")) / (b.outerHeight() - c.outerHeight());f = l * (b[0].scrollHeight - b.outerHeight());g && (f = d, d = f / b[0].scrollHeight * b.outerHeight(), d = Math.min(Math.max(d, 0), h), c.css({ top: d + "px" }));b.scrollTop(f);b.trigger("slimscrolling", ~~f);v();p();
				}function C() {
					...
					var n = b.scrollTop(),
					    ...
					    h = b.parent().find("." + a.railClass);w();if (e.isPlainObject(g)) {
  ...
  function c() {
    ...
    this._process_options(c), this.dates = new i(), this.viewDate = this.o.defaultViewDate, this.focusDate = null, this.element = a(b), this.isInline = !1, this.isInput = this.element.is("input"), this.component = this.element.hasClass("date") ? this.element.find(".add-on, .input-group-addon, .btn") : !1, this.hasInput = this.component && this.element.find("input").length, this.component && 0 === this.component.length && (this.component = !1), this.picker = a(q.template), this._buildEvents(), this._attachEvents(), this.isInline ? this.picker.addClass("datepicker-inline").appendTo(this.element) : this.picker.addClass("datepicker-dropdown dropdown-menu"), this.o.rtl && this.picker.addClass("datepicker-rtl"), this.viewMode = this.o.startView, this.o.calendarWeeks && this.picker.find("tfoot .today, tfoot .clear").attr("colspan", function (a, b) {
      ...
      var b = { keyup: a.proxy(function (b) {
          ...
          this.update(a.date);
        }, this) }]), this._secondaryEvents = [[this.picker, { click: a.proxy(this.click, this) }], [a(window), { resize: a.proxy(this.place, this) }], [a(document), { mousedown: a.proxy(function (b) {
      ...
      var c;if (b.originalEvent.clipboardData && b.originalEvent.clipboardData.types && -1 !== a.inArray("text/plain", b.originalEvent.clipboardData.types)) c = b.originalEvent.clipboardData.getData("text/plain");else {
      ...
      if (!this.picker.is(":visible")) return void ((40 === a.keyCode || 27 === a.keyCode) && this.show());var b,
          c,
          e,
          f = !1,
...
;(function ($) {
		...
		jQuery.fn.customFile = function () {
				...
				return this.each(function () {
						...
						var $file = jQuery(this).addClass('custom-file-upload-hidden'),
