                        ...
                        <div class="panel-body">
                    		...
                    		<form class="form-horizontal" name="frm-contact" action="{{route('validate_mail')}}" autocomplete='off' method="POST" data-parsley-validate>
                                ...
                                <div class="form-group">
                                    <label for="facility_name" class="col-sm-4 label-title control-label">施設名 (<span class="required">※</span>) : </label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <label for="name" class="col-sm-4 label-title control-label">お名前 (<span class="required">※</span>) : </label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <label for="email" class="col-sm-4 label-title control-label">メールアドレス (<span class="required">※</span>) : </label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <label for="email" class="col-sm-4 label-title control-label">お問い合わせ内容 (<span class="required">※</span>) : </label>
                                    <div class="col-sm-8">
